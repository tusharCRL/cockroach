...
func registerTPCC(r registry.Registry) {
	...
	r.Add(registry.TestSpec{
		...
		Cluster: spec.MakeClusterSpec(
			...
			spec.GCEMachineType("n2-standard-96"),
			spec.PreferLocalSSD(),
			spec.ReuseNone(),
		),
		CompatibleClouds:  registry.AllClouds,
		...
		Run: func(ctx context.Context, t test.Test, c cluster.Cluster) {
			setupTPCCPublishedWorkload(ctx, t, c, tpccPublishedOptions{
				warehouses:        11,
				workloadCount:     1,
				skipRamp:          true,
	...
	r.Add(registry.TestSpec{
		...
		Run: func(ctx context.Context, t test.Test, c cluster.Cluster) {
			setupTPCCPublishedCluster(ctx, t, c, tpccPublishedOptions{
				warehouses:        140001,
				workloadCount:     1,
				duration:          30 * time.Minute,
				optimized:         true,
	...
	r.Add(registry.TestSpec{
		...
		Run: func(ctx context.Context, t test.Test, c cluster.Cluster) {
			runTPCCPublished(ctx, t, c, tpccPublishedOptions{
				...
				workloadCount:     1,
				duration:          30 * time.Minute,
				LoadWarehousesGCE: 70000,
				LoadWarehousesAWS: 70000,
			})
		},
	})
...
func setupTPCCPublishedCluster(
	ctx context.Context, t test.Test, c cluster.Cluster, opts tpccPublishedOptions,
) {
	crdbNodeCount := c.Spec().NodeCount - opts.workloadCount
	crdbNodes := c.Range(1, crdbNodeCount)
...
func setupTPCCPublishedWorkload(
	ctx context.Context, t test.Test, c cluster.Cluster, opts tpccPublishedOptions,
) {
	crdbNodeCount := c.Spec().NodeCount - opts.workloadCount
	crdbNodes := c.Range(1, crdbNodeCount)
